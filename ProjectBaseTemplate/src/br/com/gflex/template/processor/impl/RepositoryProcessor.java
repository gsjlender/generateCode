...
public class RepositoryProcessor implements IProcessor
{
	...
	public RepositoryProcessor(InterfaceTemplate interfaceRepository, VOTemplate classVO)
	{
	...
	public String generate()
	{
		...
		Template template = Velocity.getTemplate("templates/repository-template.vm");
